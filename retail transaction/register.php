                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form action="phpfolder/registerphp.php" method="POST">
                                            <div class="row mb-3">
                                                <div class="col-md-6">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input name="repassword" class="form-control" id="inputPasswordConfirm" type="password" placeholder="Confirm password" />
                                            ...
                                            <div class="mt-4 mb-0">
                                                <div class="d-grid"><input class="btn btn-primary btn-block" type="submit" value="Create Account" name = "register" /></div>
