...
<html lang="en">
    <head>
        ...
        <title>Input gasoline pump 1</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Input gasoline pump 1</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                            <li class="breadcrumb-item active">Input gasoline pump 1</li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-body">
                                <form action="phpfolder/inputGp1.php" method="POST" name="laform">
