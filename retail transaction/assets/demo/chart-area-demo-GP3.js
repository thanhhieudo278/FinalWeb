...
var myLineChart = new Chart(ctx, {
  ...
  data: {
    ...
    datasets: [{
      ...
      borderColor: "rgba(118,238,198,1)",
      pointRadius: 5,
      pointBackgroundColor: "rgba(118,238,198,1)",
      pointBorderColor: "rgba(118,238,198,0.8)",
      pointHoverRadius: 5,
      pointHoverBackgroundColor: "rgba(118,238,198,1)",
      pointHitRadius: 50,
      pointBorderWidth: 2,
