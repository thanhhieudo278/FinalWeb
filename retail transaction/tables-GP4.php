...
<html lang="en">
    <head>
        ...
        <title>Table gasoline pump 4</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Table gasoline pump 4</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="index.php">
                                Home
                                </a></li>
                            <li class="breadcrumb-item active">Table gasoline pump 4</li>
                        </ol>
