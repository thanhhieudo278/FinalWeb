...
<html lang="en">
    <head>
        ...
        <title>Chart gasoline pump 2</title>
...
<!-- copy phần chung của các trang từ đây-->
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Chart gasoline pump 2</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                            <li class="breadcrumb-item active">Chart gasoline pump 2</li>
                        </ol>
                        <div class="card mb-4">
        ...
        <script src="assets/demo/chart-area-demo-GP4.js"></script>
        <script src="assets/demo/chart-bar-demo-GP4.js"></script>
    </body>
</html>
